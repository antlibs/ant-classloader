...
public class ClassloaderUtil {
    ...
    public static ClassLoaderAdapter findAdapter(ClassLoaderAdapterContext ctx, ClassLoader cl, ClassLoaderAdapterAction action) throws AdapterException {
    ...
    public static ClassLoaderAdapter findAdapter(ClassLoaderAdapterContext ctx, ClassLoader cl, ClassLoaderAdapterAction action, ClassloaderReporter to, String errPrefix, String errSuffix) {
        try {
    ...
    public static ClassLoaderAdapter findAdapter(ClassLoaderAdapterContext ctx, ClassLoader cl, ClassLoaderAdapterAction action, List errors, String errPrefix, String errSuffix) {
        try {
            return findAdapter(ctx, cl, action);
        } catch (AdapterException e) {
            switch (e.getReason()) {
    ...
    private static boolean containsEntrySelf(ClassLoaderAdapterContext ctx, ClassLoader cl, String url, List errors) {
        ClassLoaderAdapter adapter = ClassloaderUtil.findAdapter(ctx, cl, ClassLoaderAdapterAction.GETPATH, errors,
    ...
    public static boolean containsEntry(ClassLoaderAdapterContext ctx, ClassLoader cl, String url) {
     ...
     */
    private static boolean containsEntryDelegatedOrSelf(ClassLoaderAdapterContext ctx, ClassLoader cl, String url, List errors) {
        if (cl==null) {
        ...
        ClassLoaderAdapter adapter = ClassloaderUtil.findAdapter(ctx,cl, null, errors, "  parent of classloader " + cl.getClass().getModifiers(), "");
